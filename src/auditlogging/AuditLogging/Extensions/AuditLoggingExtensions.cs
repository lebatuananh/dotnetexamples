...
using AuditLogging.Events.Default;
using AuditLogging.Events.Http;
...
namespace AuditLogging.Extensions
{
    public static class AuditLoggingExtensions
    {
        ...
        /// <returns></returns>
        public static IAuditLoggingBuilder AddAuditLogging<TAuditLoggerOptions>(this IServiceCollection service,
            Action<TAuditLoggerOptions> loggerOptions = default)
        ...
        /// <returns></returns>
        public static IAuditLoggingBuilder AddDefaultHttpEventData(this IAuditLoggingBuilder builder,
            Action<AuditHttpSubjectOptions> subjectOptions = default,
            Action<AuditHttpActionOptions> actionOptions = default)
        {
        ...
        /// <returns></returns>
        public static IAuditLoggingBuilder AddStaticEventSubject(this IAuditLoggingBuilder builder,
