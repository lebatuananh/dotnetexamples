...
namespace elFinder.NetCore
{
    ...
    {
        Task<JsonResult> ArchiveAsync(FullPath parentPath, IEnumerable<FullPath> paths, string filename,
            string mimeType);
        ...
        Task<JsonResult> PasteAsync(FullPath dest, IEnumerable<FullPath> paths, bool isCut, IEnumerable<string> renames,
            string suffix);
        ...
        Task<JsonResult> UploadAsync(FullPath path, IEnumerable<IFormFile> files, bool? overwrite,
        ...
        Task<FileStreamResult> ZipDownloadAsync(FullPath cwdPath, string archivedFileKey, string downloadFileName,
            string mimeType);
    }
}