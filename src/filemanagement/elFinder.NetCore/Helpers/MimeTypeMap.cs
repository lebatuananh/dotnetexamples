...
// Would have used a NuGet package, but there doesn't appear to be one...
...
namespace elFinder.NetCore.Helpers
{
    internal static class MimeTypeMap
    {
        ...
        public static string GetExtension(string mimeType, bool throwErrorIfNotFound = true)
        {
            ...
            if (throwErrorIfNotFound) throw new ArgumentException("Requested mime type is not registered: " + mimeType);
        ...
        public static string GetMimeType(string extension)
        {
            ...
            if (!extension.StartsWith(Dot)) extension = Dot + extension;
